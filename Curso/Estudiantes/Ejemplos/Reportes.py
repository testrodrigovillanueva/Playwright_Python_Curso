...
#pytest Reportes.py -s -v --browser-channel=chrome -n 6
#v-17
#playwright codegen   https://www.saucedemo.com/
#Reportes
#pytest -s -v Reportes.py  -n 6  --html=report_uno.html
#pytest -s -v Reportes.py  -n 6 --html=report_dos.html --self-contained-html --capture=tee-sys
#Reportes tipo 2
#pytest  Reportes.py -s -v  -n 6 --template=html1/index.html --report=report_tres.html
