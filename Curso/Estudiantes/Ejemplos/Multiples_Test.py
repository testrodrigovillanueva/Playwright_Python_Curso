...
#@pytest.mark.skipif(sys.platform=="win32", reason="El test no corre por que la plataforma es de tipo win32")
@pytest.mark.skipif(sys.platform=="win62", reason="El test no corre por que la plataforma es de tipo win32")
#@pytest.mark.skipif(tiempo>=1.5, reason="No se ejecuta por que el tiempo es mayor que 1.5")
#@pytest.mark.xfail(reason="No esta cargando la validación de la Url")
...
#@pytest.mark.skip(reason="Este Modulo esta inhabilitado Checkbox")   
